...
// 	"github.com/twolodzko/gosch/macros/patterns"
...
// func newTransformer(mappings mapping.Mappings, env *envir.Env) Transformer {
...
// 	head := pair
// 	for head != nil {
// 		if head.This == patterns.Ellipsis {
...
// 	if ellipsis, ok := t.mappings[patterns.Ellipsis]; ok {
